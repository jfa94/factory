...
Use DONE for a completed review (any verdict including BLOCKED verdict above). Reserve STATUS: BLOCKED only when the review itself could not be performed. Missing STATUS line is treated as BLOCKED by the hook.
