...
- `src/cli/main.ts` — the `factory` subcommand registry (run, resume, spec, next-task, next-action, rescue, reconcile, score, state, scaffold, configure, config-defaults, debug, autonomy, statusline)
