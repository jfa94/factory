...
| `developBaselineStatusChecks` | string[] | `["Quality", "Security Scan"]`                     | The at-rest baseline profile (run-scoped mode): required checks for **non-admin** PRs into develop, `strict: false`, `enforce_admins: false` — admins can push develop directly between runs.                                                                                                                                                                                                                                                                                                  |
